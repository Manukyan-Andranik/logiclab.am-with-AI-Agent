...
<div className="min-h-screen bg-black flex items-center justify-center">
  ...
  >
    ...
    <h2 className="font-display text-3xl font-bold text-green-500 mb-4">
      Շնորհակալություն!
    </h2>

    <p className="text-[var(--success)]  mb-8">
      Ձեր հայտը հաջողությամբ ուղարկվեց։ Մենք կկապվենք ձեզ հետ շուտով։
    </p>

    <Link
      to="/"
      className="inline-flex items-center gap-2 bg-primary-alt text-gray-dark px-8 py-3 rounded-lg font-semibold hover:bg-var(--primary-hover) transition"
    >
      Գլխավոր
    </Link>
  </motion.div>
        ...
        >
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  className="w-full bg-gray-dark border border-white/20 rounded-lg px-4 py-3 text-white placeholder:text-[var(--gray-light)]/50 focus:outline-none focus:ring-2 focus:ring-[var(--primary)]/50 focus:border-primary transition-all"
                  required
                />
              </div>
              <div>
            ...
            <div>
              ...
              <select
                ...
                className="w-full bg-gray-dark border border-white/20 rounded-lg px-4 py-3 text-white focus:outline-none focus:ring-2 focus:ring-[var(--primary)]/50 focus:border-primary transition-all"
                required
            ...
            <div>
              ...
              <textarea
                ...
                rows={3}
                className="w-full bg-gray-dark border border-white/20 rounded-lg px-4 py-3 text-white placeholder:text-[var(--gray-light)]/50 focus:outline-none focus:ring-2 focus:ring-[var(--primary)]/50 focus:border-primary transition-all resize-none"
              />
            </div>
            <button
              type="submit"
