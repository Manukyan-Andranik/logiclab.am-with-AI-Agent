                    ...
                    materials.map((chapter, idx) => (
                      ...
                      >
                        ...
                        <motion.div
                          ...
                          className={`flex items-center justify-between p-6 rounded-3xl border-2 cursor-pointer transition-all duration-500 ${openChapter === chapter.chapter_id
                        ...
                        >
                          <div className="flex items-center gap-5">
                            <div
                              className={`w-10 h-10 rounded-2xl flex items-center justify-center text-sm font-black italic shadow-lg transition-colors ${openChapter === chapter.chapter_id
                          ...
                          <div className="flex items-center gap-4">
                            ...
                            <ChevronRight
                              size={20}
                              className={`transition-transform duration-500 ${openChapter === chapter.chapter_id ? "rotate-90" : ""
                                }`}
                            />
                          </div>
                        </motion.div>
