        ...
        <div className="max-w-4xl">
          ...
          >
            {tags.map((tag) => (
              <span
                key={tag}
                className="px-3 py-1 rounded-full text-xs font-medium border border-primary/40 text-primary bg-primary/10 backdrop-blur-sm text-card"
              >
                {tag}
              </span>
            ))}
          ...
          >
            ...
            <span className="text-card">Lab</span>
          </motion.h1>
          ...
          <motion.p
            ...
            className="text-lg sm:text-xl text-card/80 max-w-2xl mb-10"
          >
          ...
          >
            ...
            <a
              ...
              className="border border-card/30 text-card px-8 py-3.5 rounded-lg font-semibold text-base hover:bg-card/10 backdrop-blur-sm transition"
            >
              {"\u053f\u0561\u057a\u057e\u0565\u0584 \u0574\u0565\u0566 \u0570\u0565\u057f"}
            </a>
          </motion.div>
          ...
          >
            {stats.map((stat) => (
              <div key={stat.label}>
                ...
                <div className="text-sm text-card/70 mt-1">{stat.label}</div>
              </div>
            ))}
          </motion.div>
        </div>
